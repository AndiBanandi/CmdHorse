...
::SET HORSEPOOL=AMR,SUN,DRM,STP,PEP,NUG,LAK,TRX,OLV,APH,IVW,PPB,MWT,CHK,MBL
SET HP_EQUUS=AMR_SUN_DRM_STP_PEP_NUG_LAK_TRX_OLV_APH_IVW_PPB_MWT_CHK_MBL_JAD_DAZ_CXA_MST_CHY_PnW_DiF_TWI_VIN_OCT
SET HP_HRT=OOB_SUP_COM_FUZ
SET HP_UMA=URA_GOL
SET HP_DELT=NOL_NOL_SUS_RAL_KRS
SET HP_VOC=MKU_TTO_MKU_TTO_NRU
SET HORSEPOOL=%HP_EQUUS%_%HP_EQUUS%_%HP_HRT%_%HP_UMA%_%HP_DELT%_%HP_VOC%
::Sometimes seed the pool with additional weight for specific crossovers to incr chance of them racing together
IF %RANDOM% LEQ 8000 SET HORSEPOOL=%HORSEPOOL%_%HP_HRT%_%HP_HRT%_%HP_HRT%_%HP_HRT%_%HP_HRT%_%HP_HRT%
IF %RANDOM% LEQ 5000 SET HORSEPOOL=%HORSEPOOL%_%HP_UMA%_%HP_UMA%_%HP_UMA%,%HP_UMA%_%HP_UMA%
IF %RANDOM% LEQ 6000 SET HORSEPOOL=%HORSEPOOL%_%HP_DELT%_%HP_DELT%_%HP_DELT%_%HP_DELT%_%HP_DELT%
IF %RANDOM% LEQ 5000 SET HORSEPOOL=%HORSEPOOL%_%HP_VOC%_%HP_VOC%_%HP_VOC%
...
SET PRIZES=CCCCCCAAAAABBPRFFF$$$MMMSSSiccgHHHXmyahhf99b
...
SET HORSEARR=??? ? ??????
IF %HORSENAM%==AMR SET HORSEARR=%HORSENAM% A Amrita
...
IF %HORSENAM%==NUG SET HORSEARR=%HORSENAM% N Nugget
IF %HORSENAM%==LAK SET HORSEARR=%HORSENAM% K Last Argument of Kings
IF %HORSENAM%==TRX SET HORSEARR=%HORSENAM% T Trixie
IF %HORSENAM%==OLV SET HORSEARR=%HORSENAM% O Olive Branch
...
IF %HORSENAM%==MWT SET HORSEARR=%HORSENAM% m Merriweather
...
IF %HORSENAM%==MST SET HORSEARR=%HORSENAM% $ Morning Star
...
IF %HORSENAM%==TWI SET HORSEARR=%HORSENAM% t Twinkle Sprinkle
