...
SET HP_EQUUS=AMR,SUN,DRM,STP,PEP,NUG,LAK,TRX,OLV,APH,IVW,PPB,MWT,CHK,MBL,JAD,DAZ,CXA,MST,CHY,PnW,DiF,TWI,VIN,OCT
SET HP_HRT=OOB,SUP,COM,FUZ
SET HP_UMA=URA,GOL
SET HP_DELT=NOL,NOL,SUS,RAL,KRS
SET HP_VOC=MKU,TTO,MKU,TTO,NRU
SET HORSEPOOL=%HP_EQUUS%,%HP_EQUUS%,%HP_EQUUS%,%HP_HRT%,%HP_UMA%,%HP_DELT%,%HP_VOC%
::Sometimes seed the pool with additional weight for specific crossovers to incr chance of them racing together
IF %RANDOM% LEQ 3000 SET HORSEPOOL=%HORSEPOOL%,%HP_HRT%,%HP_HRT%,%HP_HRT%
IF %RANDOM% LEQ 3000 SET HORSEPOOL=%HORSEPOOL%,%HP_UMA%,%HP_UMA%,%HP_UMA%
IF %RANDOM% LEQ 3000 SET HORSEPOOL=%HORSEPOOL%,%HP_DELT%,%HP_DELT%,%HP_DELT%
IF %RANDOM% LEQ 3000 SET HORSEPOOL=%HORSEPOOL%,%HP_VOC%,%HP_VOC%,%HP_VOC%
