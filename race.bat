...
SET PRIZES=CCCCCCAAAAABBPRFFF$$$MMMSSSiccgHHHXmyahhf99
...
SET HORSEPOOL=%HORSEPOOL%,JAD,DAZ,CXA,MST,CHY,PnW,DiF,TWI,VIN,OCT
SET HORSEPOOL=%HORSEPOOL%,URA,GOL,OOB,SUP,COM,FUZ
SET HORSEPOOL=%HORSEPOOL%,MKU,TTO,NOL,SUS,RAL,KRS
...
IF %HORSENAM%==PnW SET HORSEARR=%HORSENAM% B Pip and Whistle
