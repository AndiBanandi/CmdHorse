...
SET EQUUS=AMR_SUN_DRM_STP_PEP_NUG_LAK_TRX_OLV_APH_IVW_PPB_MWT_CHK_MBL_JAD_DAZ_CXA_MST_CHY_PnW_DiF_TWI_VIN_OCT
SET HRT=OOB_SUP_COM_FUZ
SET UMA=URA_GOL
SET DELT=NOL_NOL_SUS_RAL_KRS
SET VOC=MKU_TTO_MKU_TTO_NRU
SET HORSEPOOL=%EQUUS%_%EQUUS%_%EQUUS%_%HRT%_%UMA%_%DELT%_%VOC%
