...
SET EQUUS=AMR_SUN_DRM_STP_PEP_NUG_LAK_TRX_OLV_APH_IVW_PPB_MWT_CHK_MBL_JAD_DAZ_CXA_MNG_CHY_PnW_DiF_TWI_VIN_OCT
...
SET PRIZES=CCCCCCAAAAABBPRFFF$$$MMMSSSiccgHHXmyahhf99b
...
IF %HORSENAM%==NUG SET HORSEARR=%HORSENAM% N Nugget & IF %RANDOM% LEQ 6000 SET HORSEARR=%HORSENAM% N A Tower That Guards The Heart
